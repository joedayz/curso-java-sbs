...
(
    DEPARTAMENTOID NUMBER(19) generated as identity
        primary key,
    NOMBRE         VARCHAR2(100),
    ESTADO         CHAR
...
InSERT InTO departamento ( nombre, estado) VALUES ( 'Lima', '1');
InSERT InTO departamento ( nombre, estado) VALUES ( 'Amazonas', '1');
InSERT InTO departamento ( nombre, estado) VALUES ( 'Arequipa', '1');
InSERT InTO departamento ( nombre, estado) VALUES ( 'Apurimac', '1');
InSERT InTO departamento ( nombre, estado) VALUES ( 'Ayacucho', '1');
InSERT InTO departamento ( nombre, estado) VALUES ( 'Cajamarca', '1');
InSERT InTO departamento ( nombre, estado) VALUES ( 'Cusco', '1');
...
INSERT INTO Opcion ( NOMBRE, DESCRIPCION, PATHURL, ICONO, ESTADO, ORDEN)
VALUES ( N'Deposito Plazo', N'Deposito de dinero', N'/deposito-plazo/result', N'fas fa-money-bill', '1', 2);
INSERT INTO Opcion ( NOMBRE, DESCRIPCION, PATHURL, ICONO, ESTADO, ORDEN)
VALUES ( N'Prestamos Personales', N'Prestamo de dinero', N'/prestamo/result', N'fas fa-hand-holding-usd', '1', 1);


create table PARAMETRO
(
    PARAMETROID NUMBER(19) generated as identity
        primary key,
    ...
    ORDEN       NUMBER(4),
    ESTADO      CHAR
        constraint CONS_PARAMETRO_ESTADO
            check (ESTADO IN ('1', '0'))
);
...
(
    ENTIDADFINANCIERAID NUMBER(19) generated as identity
        primary key,
    ...
    DEPARTAMENTOID      NUMBER(19)
        constraint FK_ENTIDADFINANCIERA_DEPARTAMENTOID
